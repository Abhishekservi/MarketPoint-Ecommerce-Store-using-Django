...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100,default="Diary") #Title, Heading
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100,default="Mp1") #Title, Heading
...
class Product(models.Model):
    ...
    sku = ShortUUIDField(unique=True, length=5,max_length=10,prefix="sku",alphabet="abcdefgh12345")
